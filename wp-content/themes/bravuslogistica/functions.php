...
require get_template_directory() . '/custom_post/header-destaque.php';
...
function imob_register_scripts() {
    ...
    wp_enqueue_script( 'imob-js', get_template_directory_uri() . '/assets/js/geral.js', array(), false, true );
